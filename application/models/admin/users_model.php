...
class Users_model extends CI_Model{
	...
	function GetUsers($options = array()) {
		...
		if(isset($options['user'])){
			...
			switch ($user) {
				case 'developer':
					$this->db->where('type_2', 'developer');
					$this->db->or_where('type_2', 'admin');
					$this->db->or_where('type_2', 'manager');
					$this->db->or_where('type_2', 'super_user');
					$this->db->or_where('type_2', 'user');
				break;
				case 'admin':
					$this->db->where('type_2', 'manager');
					$this->db->or_where('type_2', 'super_user');
					$this->db->or_where('type_2', 'user');
				break;
				case 'manager':
