...
class Articles_model extends CI_Model{
	...
	function AddArticle($options = array()) {
		...
		$new_date = new DateTime( $options['articledate'] );
		$new_date = date_format($new_date,"Y-m-d");
		$options['articledate'] = $new_date;
		...
		$options = $this->_default(array('articledate' => $new_date) , $options);
	...
	function UpdateArticle($options = array()) {
		...
		if (isset($options['articledate'])){
			$new_date = new DateTime( $options['articledate'] );
			$new_date = date_format($new_date,"Y-m-d");
			$this->db->set('articledate', $new_date);
		}
