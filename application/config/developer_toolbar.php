...
| template files.
*/
$config['developer_toolbar_template_folder'] = 'admin/developer_toolbar/';
...
| Stylesheet files.
*/
$config['developer_toolbar_stylesheet_folder'] = 'public/backend/css/developer_toolbar/';
...
| javascript files.
*/
$config['developer_toolbar_javascript_folder'] = 'public/backend/js/developer_toolbar/';
